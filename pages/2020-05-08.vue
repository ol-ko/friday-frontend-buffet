<template>
  <div>
    ...
    <Link
      ...
      author="John Papa (Principal Developer Advocate at Microsoft), Dan Wahlin (Google GDE, Microsoft MVP and regional director)"
      duration="4h 25 min"
    >
      <p>
    ...
    <BuffetGif
      link="https://media.giphy.com/media/XBXBWRWbSmM6HnjErP/giphy.gif"
    ...
    <EditionsNav prev="/2020-04-30"></EditionsNav>
  </div>
</template>
